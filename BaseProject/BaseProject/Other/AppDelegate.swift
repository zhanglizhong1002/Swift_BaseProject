...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        window?.rootViewController = MLTabBarViewController()
        window?.tintColor = MLMainColor
        UIApplication.shared.statusBarStyle = UIStatusBarStyle.lightContent
        SVProgressHUD.setDefaultStyle(.dark)
        
        IQKeyboardManager.shared.shouldToolbarUsesTextFieldTintColor = false
        IQKeyboardManager.shared.toolbarTintColor = MLMainColor
...
// MARK: - 自定义打印方法
func MLLog<T>(_ message: T, file: String = #file, funcName: String = #function, lineNum: Int = #line, color: UIColor? = nil) {
