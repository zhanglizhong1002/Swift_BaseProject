 ...
 //返回扫码结果，也可以通过继承本控制器，改写该handleCodeResult方法即可
   ...
   public  var isNeedCodeImage = false
    ...
    override open func viewDidLoad() {
        ...
        self.navigationItem.leftBarButtonItem = UIBarButtonItem(image: UIImage(named: "bt_back"), style: .plain, target: self, action: #selector(navigationBackClick))
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "相册", style: .plain, target: self, action: #selector(openLocalPhotoAlbum))
    }
